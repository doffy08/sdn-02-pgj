                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        ...
                        <div class="text-center mb-5">
                            <img src="{{ asset('assets/img/haldep.jpg') }}" class="img-fluid rounded shadow"
                                alt="Sejarah Sekolah" style="max-height: 450px; object-fit: cover;">
                        </div>
                        ...
                        <div class="content">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="timeline-item position-relative pb-4">
                                        <div class="timeline-marker bg-primary position-absolute"></div>
                                        <h5 class="fw-bold text-secondary">Saat Ini</h5>
                                        <p class="text-muted">Sekarang sekolah telah memiliki berbagai fasilitas modern
                                            seperti ruang kelas ber-AC, laboratorium komputer, perpustakaan, lapangan
                                            olahraga, dan gerbang sekolah yang representatif. Kami terus berkomitmen
                                            memberikan pendidikan berkualitas bagi generasi penerus bangsa.</p>
                                    </div>
                                </div>
                            ...
                            <div class="">
                                <p class="text-muted">
                                    Sejarah panjang sekolah kami tidak terlepas dari peran serta masyarakat, para guru,
